...
export class NutrientRouter {
    ...
    public static async create(req: express.Request, res: express.Response) {
        try {
            ...
            const result: Nutrient = await NutrientRouter.getNutrientService().create(applicationId, new Nutrient(null, req.body.name, req.body.description, req.body.code, req.body.abbreviation, req.body.unit, parseInt(req.body.sortOrder)));
    ...
    public static async update(req: express.Request, res: express.Response) {
        try {
            ...
            const result: Nutrient = await NutrientRouter.getNutrientService().update(applicationId, new Nutrient(null, req.body.name, req.body.description, req.body.code, req.body.abbreviation, req.body.unit, parseInt(req.body.sortOrder)));
