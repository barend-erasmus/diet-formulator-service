...
describe('SubscriptionFactory', () => {
    ...
    describe('create', () => {
        ...
        it('should return subscription with expired false given expiry timestamp has not past', async () => {
            ...
            const result: Subscription = subscriptionFactory.create(true, new Date(2070, 0, 0), null, new Date(2002, 0, 0), 'trial');
        ...
        it('should return subscription with expired true given expiry timestamp has past', async () => {
            ...
            const result: Subscription = subscriptionFactory.create(true, new Date(2010, 0, 0), null, new Date(2009, 0, 0), 'trial');
